...
BOARD_SECOND_OFFSET = $(if $(filter true,$(AB_OTA_UPDATER)),0x00e88000,0xbff88000)
...
ifeq ($(AB_OTA_UPDATER), false)
	...
	BOARD_MAIN_SIZE := 9124608256
	BOARD_MAIN_PARTITION_LIST := system system_dlkm system_ext product vendor vendor_dlkm odm odm_dlkm
endif
...
TARGET_RECOVERY_FSTAB := $(if $(filter true,$(AB_OTA_UPDATER)),$(COMMON_PATH)/rootdir/etc/fstab_vab.mt6768,$(COMMON_PATH)/rootdir/etc/fstab.mt6768)
...
BOARD_AVB_VBMETA_SYSTEM := $(if $(filter true,$(AB_OTA_UPDATER)),product system system_dlkm system_ext,product system system_ext)
BOARD_AVB_VBMETA_SYSTEM_KEY_PATH := external/avb/test/data/testkey_rsa2048.pem
BOARD_AVB_VBMETA_SYSTEM_ALGORITHM := SHA256_RSA2048
BOARD_AVB_VBMETA_SYSTEM_ROLLBACK_INDEX := 1
BOARD_AVB_VBMETA_SYSTEM_ROLLBACK_INDEX_LOCATION := 2

BOARD_AVB_VBMETA_VENDOR := $(if $(filter true,$(AB_OTA_UPDATER)),odm odm_dlkm vendor vendor_dlkm,vendor)
